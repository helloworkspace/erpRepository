...
public class SaleListAdminController {
	...
	public Map<String,Object> list(SaleList saleList)throws Exception{
		...
		List<SaleList> saleListList=saleListService.list(saleList, Direction.DESC, "saleNumber");
