...
import com.yla.service.CustomerReturnListGoodsService;
...
public class CustomerReturnListAdminController {
	...
	public Map<String,Object> list(CustomerReturnList customerReturnList)throws Exception{
		...
		List<CustomerReturnList> customerReturnListList=customerReturnListService.list(customerReturnList, Direction.DESC, "customerReturnNumber");
