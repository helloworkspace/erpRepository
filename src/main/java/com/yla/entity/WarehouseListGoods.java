 ...
 */
@Entity
@Table(name="t_warehouseListGoods")
public class WarehouseListGoods {
	...
	@ManyToOne
	@JoinColumn(name="warehouseListId")
	private WarehouseList warehouseList; // 进货单
	...
	public String toString() {
		return "WarehouseListGoods [id=" + id + ", code=" + code + ", name=" + name + ", model=" + model + ", type="
